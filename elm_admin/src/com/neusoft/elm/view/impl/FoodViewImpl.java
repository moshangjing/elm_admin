...
public class FoodViewImpl implements FoodView {
    ...
    public List<Food> showFoodList(Integer businessId) {
        ...
        System.out.println("食品编号\t食品名称\t食品介绍\t食品价格\t食品销售次数");
        for (Food food : list) {
            System.out.println(food.getFoodId() + "\t" + food.getFoodName() + "\t" + food.getFoodExplain() + "\t" + food
                    .getFoodPrice()+"\t"+food.getFoodCount());
        }
    ...
    public List<Food> showFoodCount(Integer businessId) {
        FoodDao dao = new FoodDaoImpl();
        List<Food> list = dao.listFoodCount(businessId);
        System.out.println("食品编号\t食品名称\t食品销售次数");
        for (Food food : list) {
            System.out.println(food.getFoodId() + "\t" + food.getFoodName() + "\t"+food.getFoodCount());
        }
        return list;
    }
}
